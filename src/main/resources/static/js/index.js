...
layui.config({
	...
	function showNotice(){
		layer.open({
	        ...
	        btn: ['火速围观'],
	        moveType: 1,
	        content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>本后台管理是使用了作者贤心的后台管理模板，并在他的基础之上定义了自己的管理内容。记住，我是祥哥。</p></div>',
